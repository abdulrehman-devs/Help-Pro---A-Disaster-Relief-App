          ...
          <div className="dash-card mt-4">
            ...
            <div className="activity-item">
              ...
              <div className="activity-text">
                Feedback on food supply quality
                <span className="time">Resolved · 3 days ago</span>
              </div>
            </div>
            <div className="activity-item">
              <div className="activity-dot orange"></div>
              <div className="activity-text">
                Reported delay in medical aid
                <span className="time">Under review · 5 days ago</span>
              </div>
            </div>
          </div>
        </div>
